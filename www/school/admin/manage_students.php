...
<tr>
    ...
    <td><?=$value['students_age']?></td>
    <td><?=$value['students_class']?></td>
    <td><?=$value['students_department']?></td>
    <td><?=$value['course']?></td>
    <td><a href="edit_students.php?id=<?=$value['students_id']?>">Edit</a></td>
    <td><a href="delete_students.php?id=<?=$value['students_id']?>">Delete</a></td>
